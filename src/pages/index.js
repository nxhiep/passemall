            ...
            <Container>
                <Grid container alignItems="stretch">
                    <Grid item xs={12} sm={5}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", justifyContent: "flex-start", width: "350px" }}>
                            <Button className={classes.root} style={{ display: props.isMobile ? "none" : "block" }} onClick={() => { onStartTest(); }} >START YOUR PRACTICE TEST</Button>
