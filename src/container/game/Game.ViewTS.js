import { Collapse, Grid, Button, IconButton, useMediaQuery, useTheme } from '@material-ui/core';
import { LockOpen as UnLockIcon, Close as CloseIcon, DoneAll as DoneAllIcon, ArrowForward as ArrowForwardIcon, ArrowBack as ArrowBackIcon, Clear as UnCheckIcon, Done as CheckIcon, Favorite as HeartIcon, FavoriteBorder as UnHeartIcon, ArrowRightAlt as ArrowRightAltIcon, Done } from '@material-ui/icons';
        ...
        return (
            <>
                ...
                <Grid
                    ...
                    <div style={{ display: "flex", flexDirection: "column", width: "calc(100% - 164px)", padding: "0px 10px 0px 10px", }}>
                    ...
                    <span style={{ display: "flex", margin: "20px 20px 0px auto" }} >
                        ...
                        {gameState.currentQuestion.progress.bookmark ?
                            <HeartIcon color="primary" onClick={() => {
                                onBookmark(gameState.currentQuestion);
                            }} />
                            :
                            <UnHeartIcon color="primary" onClick={() => {
                                setShowAlert(true);
                                onBookmark(gameState.currentQuestion);
                            }} />
                        }
