...
import { getTestInfoByAppId, setTestInfoPlaying, endTest, setTestInfoUnlock, getTopicsByParentId, getTestInfoByAppIdAndParentId } from "../../redux/actions/index";
...
const TestViewUI = ({ stateInfoState, testInfoState, appInfoState, getTestInfoByAppId = () => { }, gameState, getTestInfoByAppIdAndParentId = () => { }, setTestInfoPlaying = () => { }, setTestInfoUnlock = () => { }, endTest, getTopicsByParentId }) => {
    ...
    }, [appInfoState.id, getTestInfoByAppId, setTestInfoPlaying, setTestInfoUnlock, setCurrentTestInfo, getTestInfoByAppIdAndParentId, testInfoState.currentTopic[appInfoState.id], stateInfoState.mapCurrentStateInfo[appInfoState.id]]);
    if (isMobile) {
        return (
            <div className="body-panel test-page">
                <Container className="test-game-panel">
                    {showGame ?
                        <>
                            <Grid item xs={12} sm={12} md={7} lg={8} className="right-panel" style={{ display: isHaveRightPanel && !showLeftPanel ? "block" : "none" }}>
                                    ...
                                    <>
                                        ...
                                        <>
                                            ...
                                            <Button
                                                ...
                                                onClick={() => {
                                                    endTest();
                                                    setTestInfoUnlock(currentTestInfo.id)
                                                }}
                                                style={
                                                    {
...
const mapDispatchToProps = (dispatch) => ({
    ...
    setTestInfoUnlock: (id) => dispatch(setTestInfoUnlock(id)),
