...
const ReportDialog = ({ appId, appName, questionId }) => {
    ...
    return (
        <div>
            {!isMobile ? <IconButton onClick={handleClickOpen}><ReportIcon color="primary"></ReportIcon></IconButton> : <ReportIcon color="primary" onClick={handleClickOpen} style={{ marginRight: "8px" }}></ReportIcon>}
            <Dialog
                open={open}
                fullWidth={isMobile}
                TransitionComponent={Transition}
