import { Button, FormControlLabel, Checkbox, makeStyles, TextField, IconButton, Input } from '@material-ui/core';
...
const DialogForMobile = ({ handleInstalled }) => {
    ...
    return (
        ...
        >
            <DialogTitle id="alert-dialog-slide-title">Do you want to install app?</DialogTitle>
            <div style={{ display: "flex", justifyContent: "space-between", padding: "0px 8px" }}>
                <DialogActions>
                    <img src="/images/googlePlayIcon.png" alt="googlePlayIcon" height="42px" />
                </DialogActions>
                <DialogActions>
                    <img src="/images/appStoreIcon.png" alt="appStoreIcon" height="42px" />
                </DialogActions>
            </div>
            <DialogActions>
                <Button onClick={handleClickInstalled} color="primary">Installed!</Button>
            </DialogActions>
            <DialogActions>
